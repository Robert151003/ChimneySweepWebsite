    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto p-4">
        <section id="about" className="my-8">
          <h2 className="text-2xl font-bold mb-4">About Essex & Suffolk Sweeps</h2>
          <div >
            <p className="mt-4">
            ...
            <ul className="mt-4">
              <li>Smokeless coals: At least once a year</li>
              <li>Wood: Once a season when in use</li>
              <li>Bitumous coal: Twice a year</li>
              <li>Oil: Once a year</li>
              <li>Gas: Once a year</li>
            </ul>
            <p className="mt-4">
